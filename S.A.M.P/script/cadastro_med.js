    ...
    $("#meucadastro").submit(function(e) {
       ...
       if(semErros){
          ...
          var dados = JSON.stringify({
             NomeCompleto: NomeCompleto, DtNascimento: DtNascimento, Genero: Genero, Cpf: Cpf, Cep: Cep, Crm: Crm, 
            Email: Email, Senha: Senha, Area_Atuacao: Area_Atuacao, Especialidade: Especialidade
          });
          // Faz o envio por meio do método ajax
          $.ajax({
             url: 'http://localhost:5000/incluir_medico', // Endereço do banco de dados
